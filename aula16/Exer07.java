	    ...
	    double numero1=scan.nextDouble();
	           ...
	           double numero2=scan.nextDouble();
	                  ...
	                  {System.out.println("Numero maior é: " + numero1);
	                   System.out.println("Numero menor é: " + numero3);
	                  }
	                  else if((numero1 >= numero2) && (numero1 >= numero3) && (numero2 <= numero3))
	                  {System.out.println("Numero maior é: " + numero1);
	                   System.out.println("Numero menor é: " + numero2);
	                  }
		              ...
		              {System.out.println("Numero maior é: " + numero2);
		                   System.out.println("Numero menor é: " + numero1);
                  	  }
	                  else if((numero3 >= numero1) && (numero3 >= numero2) && (numero1 >= numero2))
		              {System.out.println("Numero maior é: " + numero3);
		                   System.out.println("Numero menor é: " + numero2);
                  	  }
	                  else if((numero3 >= numero1) && (numero3 >= numero2) && (numero1 <= numero2))
		              {System.out.println("Numero maior é: " + numero3);
